<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="musicList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="音乐的路径" align="center" prop="musicUrl" show-overflow-tooltip />
      <el-table-column label="音乐名称" align="center" prop="musicName" show-overflow-tooltip />
      <el-table-column label="音乐分类名称" align="center" prop="sortName" show-overflow-tooltip/>
