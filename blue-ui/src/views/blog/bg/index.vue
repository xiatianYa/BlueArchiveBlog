...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除网站背景资源信息编号为"' + ids + '"的数据项？').then(function() {
        return delBg(ids);
      }).then(() => {
        this.getList();
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('system/bg/export', {
        ...this.queryParams
