<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="messageList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="弹幕内容" align="center" prop="content" show-overflow-tooltip/>
      <el-table-column label="用户头像" align="center" prop="userAvater" show-overflow-tooltip/>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除弹幕编号为"' + ids + '"的数据项？').then(function() {
